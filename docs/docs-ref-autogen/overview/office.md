# <a name="office-javascript-api-reference"></a><span data-ttu-id="b5761-101">Office JavaScript-API-Referenz</span><span class="sxs-lookup"><span data-stu-id="b5761-101">Office JavaScript API reference</span></span>
