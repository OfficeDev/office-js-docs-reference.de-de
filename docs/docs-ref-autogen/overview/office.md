# <a name="office-javascript-api-reference"></a><span data-ttu-id="ccd2e-101">Office JavaScript-API-Referenz</span><span class="sxs-lookup"><span data-stu-id="ccd2e-101">Office JavaScript API reference</span></span>
