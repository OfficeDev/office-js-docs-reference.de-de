...
|[ChartAreaFormat](/javascript/api/excel/excel.chartareaformat)|[border](/javascript/api/excel/excel.chartareaformat#border)|Stellt das Rahmenformat des Diagrammbereichs dar, das Farbe, Linienart und Gewichtung enthält.|
|[ChartAxes](/javascript/api/excel/excel.chartaxes)|[GetItem (Typ: Excel. ChartAxisType, Group?: Excel. ChartAxisGroup)](/javascript/api/excel/excel.chartaxes#getitem-type--group-)|Gibt eine bestimmte Achse anhand des Typs und der Gruppe zurück.|
...
||[Display Unit](/javascript/api/excel/excel.chartaxis#displayunit)|Die Anzeigeeinheit für die Achse.|
||[logBase](/javascript/api/excel/excel.chartaxis#logbase)|Gibt die Basis des Logarithmus an, wenn Logarithmische Skalen verwendet werden.|
||[majorTickMark](/javascript/api/excel/excel.chartaxis#majortickmark)|Gibt den Typ der Haupt Teilstrich Markierung für die angegebene Achse an.|
||[majorTimeUnitScale](/javascript/api/excel/excel.chartaxis#majortimeunitscale)|Gibt den Haupt Wert der Skalen Einheit für die Rubrikenachse an, wenn die kategorietype-Eigenschaft auf Zeitskala festgelegt ist.|
||[minorTickMark](/javascript/api/excel/excel.chartaxis#minortickmark)|Gibt den Typ der geringfügigen Teilstrich Markierung für die angegebene Achse an.|
||[minorTimeUnitScale](/javascript/api/excel/excel.chartaxis#minortimeunitscale)|Gibt den kleineren Einheiten Skalierungswert für die Rubrikenachse an, wenn die kategorietype-Eigenschaft auf Zeitskala festgelegt ist.|
||[axisGroup](/javascript/api/excel/excel.chartaxis#axisgroup)|Gibt die Gruppe für die angegebene Achse an.|
||[customDisplayUnit](/javascript/api/excel/excel.chartaxis#customdisplayunit)|Gibt den Wert der benutzerdefinierten Achsenanzeige Einheit an.|
...
||[setCustomDisplayUnit (Wert: Number)](/javascript/api/excel/excel.chartaxis#setcustomdisplayunit-value-)|Legt für die Anzeigeeinheit der Achse einen benutzerdefinierten Wert fest.|
||[showDisplayUnitLabel](/javascript/api/excel/excel.chartaxis#showdisplayunitlabel)|Gibt an, ob die Achsenanzeige Einheitenbezeichnung sichtbar ist.|
...
||[tickLabelSpacing](/javascript/api/excel/excel.chartaxis#ticklabelspacing)|Gibt die Anzahl von Kategorien oder Datenreihen zwischen Teilstrichbeschriftungen an.|
||[tickMarkSpacing](/javascript/api/excel/excel.chartaxis#tickmarkspacing)|Gibt die Anzahl von Kategorien oder Datenreihen zwischen Teilstrichen an.|
...
|[ChartDataLabel](/javascript/api/excel/excel.chartdatalabel)|[position](/javascript/api/excel/excel.chartdatalabel#position)|DataLabelPosition-Wert, der die Position der Datenbeschriftung darstellt.|
||[Separator](/javascript/api/excel/excel.chartdatalabel#separator)|Zeichenfolge, die das Trennzeichen für die Datenbeschriftungen in einem Diagramm darstellt.|
||[showBubbleSize](/javascript/api/excel/excel.chartdatalabel#showbubblesize)|Gibt an, ob die Daten Beschriftungs Blasengröße sichtbar ist.|
||[showCategoryName](/javascript/api/excel/excel.chartdatalabel#showcategoryname)|Gibt an, ob der Name der Daten Beschriftungskategorie sichtbar ist.|
||[showLegendKey](/javascript/api/excel/excel.chartdatalabel#showlegendkey)|Gibt an, ob der Legendenschlüssel für die Datenbeschriftung sichtbar ist.|
...
||[showSeriesName](/javascript/api/excel/excel.chartdatalabel#showseriesname)|Gibt an, ob der Name der Daten Beschriftungs Reihe sichtbar ist.|
||[ShowValue](/javascript/api/excel/excel.chartdatalabel#showvalue)|Gibt an, ob der Wert der Datenbeschriftung sichtbar ist.|
|[ChartFormatString](/javascript/api/excel/excel.chartformatstring)|[font](/javascript/api/excel/excel.chartformatstring#font)|Stellt die Schriftartattribute dar, beispielsweise Schriftartname, Schriftgrad, Farbe usw.|
...
||[left](/javascript/api/excel/excel.chartlegend#left)|Gibt die linke (in Punkt) der Legende im Diagramm an.|
...
||[showShadow](/javascript/api/excel/excel.chartlegend#showshadow)|Gibt an, ob die Legende einen Schatten im Diagramm aufweist.|
||[top](/javascript/api/excel/excel.chartlegend#top)|Gibt den oberen Rand einer Diagrammlegende an.|
||[width](/javascript/api/excel/excel.chartlegend#width)|Gibt die Breite der Legende im Diagramm in Punkten an.|
|[ChartLegendEntry](/javascript/api/excel/excel.chartlegendentry)|[visible](/javascript/api/excel/excel.chartlegendentry#visible)|Stellt den sichtbaren Teil eines Diagrammlegendeneintrags dar.|
|[ChartLegendEntryCollection](/javascript/api/excel/excel.chartlegendentrycollection)|[getCount()](/javascript/api/excel/excel.chartlegendentrycollection#getcount--)|Gibt die Anzahl der legendEntry-Objekte in der Sammlung zurück.|
||[getItemAt(index: number)](/javascript/api/excel/excel.chartlegendentrycollection#getitemat-index-)|Gibt einen LegendEntry im angegebenen Index zurück.|
...
|[ChartLineFormat](/javascript/api/excel/excel.chartlineformat)|[LineStyle](/javascript/api/excel/excel.chartlineformat#linestyle)|Stellt das Linienformat dar.|
||[weight](/javascript/api/excel/excel.chartlineformat#weight)|Stärke der Linie, angegeben in Punkt.|
|[ChartPoint](/javascript/api/excel/excel.chartpoint)|[hasDataLabel](/javascript/api/excel/excel.chartpoint#hasdatalabel)|Stellt dar, ob ein Datenpunkt eine Datenbeschriftung aufweist.|
||[markerBackgroundColor](/javascript/api/excel/excel.chartpoint#markerbackgroundcolor)|HTML-Farb Codedarstellung der Marker-Hintergrundfarbe des Datenpunkts (z. b. #FF0000 rot darstellt).|
||[markerForegroundColor](/javascript/api/excel/excel.chartpoint#markerforegroundcolor)|HTML-Farb Codedarstellung der Marker-Vordergrundfarbe des Datenpunkts (z. b. #FF0000 steht für rot).|
||[markerSize](/javascript/api/excel/excel.chartpoint#markersize)|Stellt die Markergröße eines Datenpunkts dar.|
...
|[ChartPointFormat](/javascript/api/excel/excel.chartpointformat)|[border](/javascript/api/excel/excel.chartpointformat#border)|Stellt das Rahmenformat eines Diagrammdaten Punktes dar, das Farbe, Format und Gewichtungsinformationen enthält.|
...
||[markerStyle](/javascript/api/excel/excel.chartseries#markerstyle)|Gibt das Markierungs Format einer Diagrammreihe an.|
||[plotOrder](/javascript/api/excel/excel.chartseries#plotorder)|Gibt die Zeichnungsreihenfolge einer Diagrammreihe in der Diagrammgruppe an.|
||[Trendlines](/javascript/api/excel/excel.chartseries#trendlines)|Die Sammlung von Trendlinien in der Datenreihe.|
...
||[Setwerte (SourceData: Range)](/javascript/api/excel/excel.chartseries#setvalues-sourcedata-)|Legt die Werte für eine Diagrammreihe fest.|
...
||[Smooth](/javascript/api/excel/excel.chartseries#smooth)|Gibt an, ob die Datenreihe glatt ist.|
...
|[ChartTitle](/javascript/api/excel/excel.charttitle)|[getsubsting (Start: Number, length: Number)](/javascript/api/excel/excel.charttitle#getsubstring-start--length-)|Rufen Sie die Teilzeichenfolge eines Diagrammtitels ab.|
...
||[left](/javascript/api/excel/excel.charttitle#left)|Gibt den Abstand zwischen dem linken Rand des Diagrammtitels und dem linken Rand des Diagrammbereichs in Punkten an.|
...
||[width](/javascript/api/excel/excel.charttitle#width)|Gibt die Breite des Diagrammtitels in Punkten an.|
||[setformula (Formel: Zeichenfolge)](/javascript/api/excel/excel.charttitle#setformula-formula-)|Legt einen Zeichenfolgenwert fest, der die Formel des Diagrammtitels unter Verwendung der A1-Schreibweise angibt.|
...
||[top](/javascript/api/excel/excel.charttitle#top)|Gibt den Abstand zwischen dem oberen Rand des Diagrammtitels und dem oberen Rand des Diagrammbereichs in Punkten an.|
...
|[ChartTitleFormat](/javascript/api/excel/excel.charttitleformat)|[border](/javascript/api/excel/excel.charttitleformat#border)|Stellt das Rahmenformat des Diagrammtitels dar, das Farbe, Linienart und Gewichtung enthält.|
...
||[movingAveragePeriod](/javascript/api/excel/excel.charttrendline#movingaverageperiod)|Stellt den Zeitraum einer Diagramm Trendlinie dar.|
...
|[DataConnectionCollection](/javascript/api/excel/excel.dataconnectioncollection)|[refreshAll ()](/javascript/api/excel/excel.dataconnectioncollection#refreshall--)|Aktualisiert alle Datenverbindungen in der Sammlung.|
...
||[manager](/javascript/api/excel/excel.documentproperties#manager)|Der Manager der Arbeitsmappe.|
...
|[Range](/javascript/api/excel/excel.range)|[getAbsoluteResizedRange (numRows: Number, NumColumns: Number)](/javascript/api/excel/excel.range#getabsoluteresizedrange-numrows--numcolumns-)|Ruft ein Bereichsobjekt ab, das die gleiche Zelle oben links aufweist wie das aktuelle Bereichsobjekt, jedoch über eine angegebene Anzahl von Reihen uns Spalten verfügt.|
||[GetImage ()](/javascript/api/excel/excel.range#getimage--)|Rendert den Bereich als Base64-codiertes PNG-Bild.|
||[getSurroundingRegion()](/javascript/api/excel/excel.range#getsurroundingregion--)|Gibt ein Bereichsobjekt zurück, das die umgebenden Region für die Zelle oben links in diesem Bereich darstellt.|
||[hyperlink](/javascript/api/excel/excel.range#hyperlink)|Stellt den Hyperlink für den aktuellen Bereich dar.|
||[numberFormatLocal](/javascript/api/excel/excel.range#numberformatlocal)|Stellt basierend auf den Spracheinstellungen des Benutzers den Zahlenformatcode für Excel für den angegebenen Bereich dar.|
...
||[useStandardHeight](/javascript/api/excel/excel.rangeformat#usestandardheight)|Legt fest, ob die Zeilenhöhe des Bereichsobjekts mit der Standardhöhe des Blatts übereinstimmt.|
...
|[RangeHyperlink](/javascript/api/excel/excel.rangehyperlink)|[address](/javascript/api/excel/excel.rangehyperlink#address)|Stellt das Ziel der URL für den Link dar.|
||[documentReference](/javascript/api/excel/excel.rangehyperlink#documentreference)|Stellt das Dokumentreferenz Ziel für den Hyperlink dar.|
...
||[includeAlignment](/javascript/api/excel/excel.style#includealignment)|Gibt an, ob die Formatvorlage die Eigenschaften autoindent, HorizontalAlignment, VerticalAlignment, WrapText, IndentLevel und textorientation enthält.|
||[includeBorder](/javascript/api/excel/excel.style#includeborder)|Gibt an, ob die Formatvorlage die Eigenschaften Color, ColorIndex, Linienart und Gewichtungs Rahmen enthält.|
||[includeFont](/javascript/api/excel/excel.style#includefont)|Gibt an, ob die Formatvorlage die Schriftarteigenschaften background, Bold, Color, ColorIndex, FontStyle, kursiv, Name, Größe, durchgestrichen, tiefgestellt, hochgestellt und unterstrichen enthält.|
||[includeNumber](/javascript/api/excel/excel.style#includenumber)|Gibt an, ob die Formatvorlage die NumberFormat-Eigenschaft enthält.|
||[includePatterns](/javascript/api/excel/excel.style#includepatterns)|Gibt an, ob die Formatvorlage die Interior-Eigenschaften Color, ColorIndex, InvertIfNegative, pattern, PatternColor und PatternColorIndex enthält.|
||[includeProtection](/javascript/api/excel/excel.style#includeprotection)|Gibt an, ob die Formatvorlage die Eigenschaften FormulaHidden und Locked Protection enthält.|
...
||[borders](/javascript/api/excel/excel.style#borders)|Eine Auflistung von vier Rahmenobjekten, die die vier Rahmenlinien eines Bereichs- oder Style-Objekts darstellen.|
...
||[fill](/javascript/api/excel/excel.style#fill)|Der Inhalt der Formatvorlage.|
||[font](/javascript/api/excel/excel.style#font)|Gibt ein Schriftartobjekt zurück, das die Schriftart der Formatvorlage darstellt.|
||[name](/javascript/api/excel/excel.style#name)|Der Name der Formatvorlage.|
||[shrinkToFit](/javascript/api/excel/excel.style#shrinktofit)|Gibt an, ob Text automatisch verkleinert wird, sodass er in die verfügbare Spaltenbreite passt.|
...
||[wrapText](/javascript/api/excel/excel.style#wraptext)|Gibt an, ob der Text im Objekt von Excel umbrochen wird.|
...
||[getItem(name: string)](/javascript/api/excel/excel.stylecollection#getitem-name-)|Ruft eine Formatvorlage anhand des Namens ab.|
...
||[onSelectionChanged](/javascript/api/excel/excel.table#onselectionchanged)|Tritt auf, wenn sich die Auswahl für eine bestimmte Tabelle ändert.|
...
||[protection](/javascript/api/excel/excel.workbook#protection)|Gibt das Protection-Objekt für eine Arbeitsmappe zurück.|
...
||[geschützte](/javascript/api/excel/excel.workbookprotection#protected)|Gibt an, ob die Arbeitsmappe geschützt ist.|
||[Aufheben des Schutzes (Password?: String)](/javascript/api/excel/excel.workbookprotection#unprotect-password-)|Schützt eine Arbeitsmappe.|
...
||[getRangeByIndexes (startRow: Number, startColumn: Number, ROWCOUNT: Number, ColumnCount: Number)](/javascript/api/excel/excel.worksheet#getrangebyindexes-startrow--startcolumn--rowcount--columncount-)|Ruft das Bereichsobjekt, beginnend an einem bestimmten Zeilen- und Spaltenindex, das eine bestimmte Anzahl von Zeilen und Spalten umfasst.|
||[freezePanes](/javascript/api/excel/excel.worksheet#freezepanes)|Ruft ein Objekt ab, das zum Bearbeiten von fixierten Bereichen auf dem Arbeitsblatt verwendet werden kann.|
...
|[WorksheetProtection](/javascript/api/excel/excel.worksheetprotection)|[Aufheben des Schutzes (Password?: String)](/javascript/api/excel/excel.worksheetprotection#unprotect-password-)|Hebt den Schutz eines Arbeitsblatts auf.|
|[WorksheetProtectionOptions](/javascript/api/excel/excel.worksheetprotectionoptions)|[allowEditObjects](/javascript/api/excel/excel.worksheetprotectionoptions#alloweditobjects)|Stellt die Arbeitsblatt-Schutzoption zum Zulassen der Bearbeitung von Objekten dar.|
