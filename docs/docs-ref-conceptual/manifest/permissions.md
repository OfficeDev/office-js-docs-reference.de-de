# <a name="permissions-element"></a><span data-ttu-id="f6724-101">Permissions-Element</span><span class="sxs-lookup"><span data-stu-id="f6724-101">Permissions element</span></span>
