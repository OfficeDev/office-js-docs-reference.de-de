# <a name="officemenu-element"></a><span data-ttu-id="a6de9-101">OfficeMenu-Element</span><span class="sxs-lookup"><span data-stu-id="a6de9-101">OfficeMenu element</span></span>
