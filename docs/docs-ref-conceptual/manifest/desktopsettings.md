# <a name="desktopsettings-element"></a><span data-ttu-id="6c0a1-101">DesktopSettings-Element</span><span class="sxs-lookup"><span data-stu-id="6c0a1-101">DesktopSettings element</span></span>
