# <a name="appdomain-element"></a><span data-ttu-id="1b379-101">AppDomain-Element</span><span class="sxs-lookup"><span data-stu-id="1b379-101">AppDomain element</span></span>
