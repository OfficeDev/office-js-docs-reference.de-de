# <a name="phonesettings-element"></a><span data-ttu-id="3c1d7-101">PhoneSettings-Element</span><span class="sxs-lookup"><span data-stu-id="3c1d7-101">PhoneSettings element</span></span>
