# <a name="allowsnapshot-element"></a><span data-ttu-id="0f371-101">AllowSnapshot-Element</span><span class="sxs-lookup"><span data-stu-id="0f371-101">AllowSnapshot element</span></span>
