# <a name="targetdialect-element"></a><span data-ttu-id="57bda-101">TargetDialect-Element</span><span class="sxs-lookup"><span data-stu-id="57bda-101">TargetDialect element</span></span>
