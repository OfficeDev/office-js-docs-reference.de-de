# <a name="highresolutioniconurl-element"></a><span data-ttu-id="a1eec-101">HighResolutionIconUrl-Element</span><span class="sxs-lookup"><span data-stu-id="a1eec-101">HighResolutionIconUrl element</span></span>
