...
| Dialog | Finden Sie unter [Dialog API-anforderungssätzen](dialog-api-requirement-sets.md). | UI.messageParent<br>UI.displayDialogAsync<br>UI.closeContainer<br>UI.Dialog |
