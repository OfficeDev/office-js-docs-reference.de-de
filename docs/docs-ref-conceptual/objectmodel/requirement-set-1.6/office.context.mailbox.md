...
| [convertToLocalClientTime](#converttolocalclienttimetimevalue--localclienttimejavascriptapioutlook16officelocalclienttime) | Methode |
...
|`restVersion`| [Office.MailboxEnums.RestVersion](/javascript/api/outlook_1_6/office.mailboxenums.restversion)|Ein Wert, der die Version der Outlook-REST-API angibt, die zum Abrufen der Element-ID verwendet wurde.|
...
Typ: [LocalClientTime](/javascript/api/outlook_1_6/office.LocalClientTime)
...
|`restVersion`| [Office.MailboxEnums.RestVersion](/javascript/api/outlook_1_6/office.mailboxenums.restversion)|Ein Wert, der die Version der Outlook-REST-API angibt, mit der die konvertierte ID verwendet wird.|
...
|Name| Typ| Beschreibung|
|---|---|---|
|`input`| [LocalClientTime](/javascript/api/outlook_1_6/office.LocalClientTime)|Der zu konvertierende Wert für die lokale Uhrzeit.|
