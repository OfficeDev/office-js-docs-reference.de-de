...
| [<span data-ttu-id="d4c5e-137">getCallbackTokenAsync</span><span class="sxs-lookup"><span data-stu-id="d4c5e-137">getCallbackTokenAsync</span></span>](#getcallbacktokenasyncoptions-callback) | <span data-ttu-id="d4c5e-138">Methode</span><span class="sxs-lookup"><span data-stu-id="d4c5e-138">Method</span></span> |
...
##### <a name="type"></a><span data-ttu-id="d4c5e-177">Typ:</span><span class="sxs-lookup"><span data-stu-id="d4c5e-177">Type:</span></span>
...
| `options.asyncContext` | <span data-ttu-id="d4c5e-207">Object</span><span class="sxs-lookup"><span data-stu-id="d4c5e-207">Object</span></span> | <span data-ttu-id="d4c5e-208">&lt;optional&gt;</span><span class="sxs-lookup"><span data-stu-id="d4c5e-208">&lt;optional&gt;</span></span> | <span data-ttu-id="d4c5e-209">Entwickler können ein Objekt bereitstellen, auf das sie in der Callbackmethode zugreifen möchten.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-209">Developers can provide any object they wish to access in the callback method.</span></span> |
...
##### <a name="parameters"></a><span data-ttu-id="d4c5e-228">Parameter:</span><span class="sxs-lookup"><span data-stu-id="d4c5e-228">Parameters:</span></span>
...
<span data-ttu-id="d4c5e-273">Wandelt eine für EWS formatierte Element-ID ins REST-Format um.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-273">Converts an item ID formatted for EWS into REST format.</span></span>
...
####  <a name="converttoutcclienttimeinput--date"></a><span data-ttu-id="d4c5e-297">convertToUtcClientTime(input) → {Date}</span><span class="sxs-lookup"><span data-stu-id="d4c5e-297">convertToUtcClientTime(input) → {Date}</span></span>
...
####  <a name="displayappointmentformitemid"></a><span data-ttu-id="d4c5e-319">displayAppointmentForm(itemId)</span><span class="sxs-lookup"><span data-stu-id="d4c5e-319">displayAppointmentForm(itemId)</span></span>
...
##### <a name="example"></a><span data-ttu-id="d4c5e-342">Beispiel</span><span class="sxs-lookup"><span data-stu-id="d4c5e-342">Example</span></span>
...
|<span data-ttu-id="d4c5e-358">Anforderung</span><span class="sxs-lookup"><span data-stu-id="d4c5e-358">Requirement</span></span>| <span data-ttu-id="d4c5e-359">Wert</span><span class="sxs-lookup"><span data-stu-id="d4c5e-359">Value</span></span>|
|---|---|
...
|<span data-ttu-id="d4c5e-407">Anforderung</span><span class="sxs-lookup"><span data-stu-id="d4c5e-407">Requirement</span></span>| <span data-ttu-id="d4c5e-408">Wert</span><span class="sxs-lookup"><span data-stu-id="d4c5e-408">Value</span></span>|
|---|---|
...
<span data-ttu-id="d4c5e-421">**REST-Tokens**</span><span class="sxs-lookup"><span data-stu-id="d4c5e-421">**REST Tokens**</span></span>
...
<span data-ttu-id="d4c5e-490">Ruft ein Token ab, das den Benutzer und das Office-Add-In identifiziert.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-490">Gets a token identifying the user and the Office Add-in.</span></span>
...
<span data-ttu-id="d4c5e-514">Richtet eine asynchrone Anforderung an einen EWS-Dienst (Exchange Web Services) auf dem Exchange-Server, der das Postfach des Benutzers hostet.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-514">Makes an asynchronous request to an Exchange Web Services (EWS) service on the Exchange server that hosts the user’s mailbox.</span></span>

> [!NOTE]
> <span data-ttu-id="d4c5e-515">Diese Methode wird in den folgenden Szenarien nicht unterstützt.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-515">This method is not supported in the following scenarios.</span></span>
> - <span data-ttu-id="d4c5e-516">In Outlook für iOS oder Outlook für Android</span><span class="sxs-lookup"><span data-stu-id="d4c5e-516">In Outlook for iOS or Outlook for Android</span></span>
> - <span data-ttu-id="d4c5e-517">Wenn das Add-In geladen wird, in einem Postfach Google Mail</span><span class="sxs-lookup"><span data-stu-id="d4c5e-517">When the add-in is loaded in a Gmail mailbox</span></span>
> 
> <span data-ttu-id="d4c5e-518">In diesen Fällen sollte-add-ins [mithilfe von REST-APIs](https://docs.microsoft.com/outlook/add-ins/use-rest-api) , stattdessen Zugriff auf das Postfach des Benutzers.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-518">In these cases, add-ins should [use REST APIs](https://docs.microsoft.com/outlook/add-ins/use-rest-api) to access the user's mailbox instead.</span></span>

<span data-ttu-id="d4c5e-519">Die `makeEwsRequestAsync`-Methode sendet eine EWS-Anforderung für das Add-In zu Exchange.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-519">The `makeEwsRequestAsync` method sends an EWS request on behalf of the add-in to Exchange.</span></span> <span data-ttu-id="d4c5e-520">Eine Liste der unterstützten EWS-Vorgänge finden Sie unter [Aufrufen von Webdiensten aus einem Outlook-add-in](https://docs.microsoft.com/outlook/add-ins/web-services#ews-operations-that-add-ins-support) .</span><span class="sxs-lookup"><span data-stu-id="d4c5e-520">See [Call web services from an Outlook add-in](https://docs.microsoft.com/outlook/add-ins/web-services#ews-operations-that-add-ins-support) for a list of the supported EWS operations.</span></span>

<span data-ttu-id="d4c5e-521">Sie können keine Elemente, die Ordnern zugeordnet sind, mit der `makeEwsRequestAsync`-Methode anfordern.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-521">You cannot request Folder Associated Items with the `makeEwsRequestAsync` method.</span></span>

<span data-ttu-id="d4c5e-522">Die XML-Anfrage muss UTF-8-Codierung angeben.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-522">The XML request must specify UTF-8 encoding.</span></span>

```xml
<?xml version="1.0" encoding="utf-8"?>
```

<span data-ttu-id="d4c5e-p133">Das Add-In muss über die **ReadWriteMailbox**-Berechtigung verfügen, um die `makeEwsRequestAsync`-Methode zu verwenden. Informationen zur **ReadWriteMailbox**-Berechtigung und zu den EWS-Vorgängen, die Sie mit der `makeEwsRequestAsync`-Methode aufrufen können, finden Sie unter [Angeben von Berechtigungen für den E-Mail-Add-In-Zugriff auf das Benutzerpostfach](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions).</span><span class="sxs-lookup"><span data-stu-id="d4c5e-p133">Your add-in must have the **ReadWriteMailbox** permission to use the `makeEwsRequestAsync` method. For information about using the **ReadWriteMailbox** permission and the EWS operations that you can call with the `makeEwsRequestAsync` method, see [Specify permissions for mail add-in access to the user's mailbox](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions).</span></span>

> [!NOTE]
> <span data-ttu-id="d4c5e-525">Der Serveradministrator muss festgelegt `OAuthAuthentication` auf "true" auf dem Client Access Server EWS-Verzeichnis so aktivieren Sie die `makeEwsRequestAsync` -Methode, um EWS stellen anfordert.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-525">The server administrator must set `OAuthAuthentication` to true on the Client Access Server EWS directory to enable the `makeEwsRequestAsync` method to make EWS requests.</span></span>

##### <a name="version-differences"></a><span data-ttu-id="d4c5e-526">Versionsunterschiede</span><span class="sxs-lookup"><span data-stu-id="d4c5e-526">Version differences</span></span>

<span data-ttu-id="d4c5e-527">Wenn Sie die `makeEwsRequestAsync`-Methode in Mail-Apps verwenden, die in älteren Outlook-Versionen als Version 15.0.4535.1004 ausgeführt werden, sollten Sie den Codierungswert auf `ISO-8859-1` festlegen.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-527">When you use the `makeEwsRequestAsync` method in mail apps running in Outlook versions earlier than version 15.0.4535.1004, you should set the encoding value to `ISO-8859-1`.</span></span>

```xml
<?xml version="1.0" encoding="iso-8859-1"?>
```

<span data-ttu-id="d4c5e-p134">Sie müssen den Codierungswert nicht festlegen, wenn Ihre Mail-App in Outlook im Web ausgeführt wird. Sie können mithilfe der mailbox.diagnostics.hostName-Eigenschaft ermitteln, ob Ihre Mail-App in Outlook oder Outlook im Web ausgeführt wird. Sie können mithilfe der mailbox.diagnostics.hostVersion-Eigenschaft ermitteln, welche Version von Outlook ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-p134">You do not need to set the encoding value when your mail app is running in Outlook on the web. You can determine whether your mail app is running in Outlook or Outlook on the web by using the mailbox.diagnostics.hostName property. You can determine what version of Outlook is running by using the mailbox.diagnostics.hostVersion property.</span></span>

##### <a name="parameters"></a><span data-ttu-id="d4c5e-531">Parameter:</span><span class="sxs-lookup"><span data-stu-id="d4c5e-531">Parameters:</span></span>

|<span data-ttu-id="d4c5e-532">Name</span><span class="sxs-lookup"><span data-stu-id="d4c5e-532">Name</span></span>| <span data-ttu-id="d4c5e-533">Typ</span><span class="sxs-lookup"><span data-stu-id="d4c5e-533">Type</span></span>| <span data-ttu-id="d4c5e-534">Attribute</span><span class="sxs-lookup"><span data-stu-id="d4c5e-534">Attributes</span></span>| <span data-ttu-id="d4c5e-535">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="d4c5e-535">Description</span></span>|
|---|---|---|---|
|`data`| <span data-ttu-id="d4c5e-536">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="d4c5e-536">String</span></span>||<span data-ttu-id="d4c5e-537">Die EWS-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-537">The EWS request.</span></span>|
|`callback`| <span data-ttu-id="d4c5e-538">Funktion</span><span class="sxs-lookup"><span data-stu-id="d4c5e-538">function</span></span>||<span data-ttu-id="d4c5e-539">Wenn die Methode abgeschlossen wird, wird die Funktion , die im `callback`-Parameter übergeben wird, mit einem einzelnen Parameter (`asyncResult`) aufgerufen, der ein [`AsyncResult`](/javascript/api/office/office.asyncresult)-Objekt darstellt.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-539">When the method completes, the function passed in the `callback` parameter is called with a single parameter, `asyncResult`, which is an [`AsyncResult`](/javascript/api/office/office.asyncresult) object.</span></span><br/><br/><span data-ttu-id="d4c5e-540">Das XML-Ergebnis des EWS-Aufrufs wird als Zeichenfolge in der `asyncResult.value`-Eigenschaft bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-540">The XML result of the EWS call is provided as a string in the `asyncResult.value` property.</span></span> <span data-ttu-id="d4c5e-541">Wenn das Ergebnis 1 MB Größe überschreitet, wird stattdessen eine Fehlermeldung zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-541">If the result exceeds 1 MB in size, an error message is returned instead.</span></span>|
|`userContext`| <span data-ttu-id="d4c5e-542">Objekt</span><span class="sxs-lookup"><span data-stu-id="d4c5e-542">Object</span></span>| <span data-ttu-id="d4c5e-543">&lt;optional&gt;</span><span class="sxs-lookup"><span data-stu-id="d4c5e-543">&lt;optional&gt;</span></span>|<span data-ttu-id="d4c5e-544">Jegliche Zustandsdaten, die an die asynchrone Methode übergeben werden.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-544">Any state data that is passed to the asynchronous method.</span></span>|

##### <a name="requirements"></a><span data-ttu-id="d4c5e-545">Anforderungen</span><span class="sxs-lookup"><span data-stu-id="d4c5e-545">Requirements</span></span>

|<span data-ttu-id="d4c5e-546">Anforderung</span><span class="sxs-lookup"><span data-stu-id="d4c5e-546">Requirement</span></span>| <span data-ttu-id="d4c5e-547">Wert</span><span class="sxs-lookup"><span data-stu-id="d4c5e-547">Value</span></span>|
|---|---|
|[<span data-ttu-id="d4c5e-548">Mindestversion des Postfachanforderungssatzes</span><span class="sxs-lookup"><span data-stu-id="d4c5e-548">Minimum mailbox requirement set version</span></span>](/javascript/office/requirement-sets/outlook-api-requirement-sets)| <span data-ttu-id="d4c5e-549">1.0</span><span class="sxs-lookup"><span data-stu-id="d4c5e-549">1.0</span></span>|
|[<span data-ttu-id="d4c5e-550">Mindestberechtigungsstufe</span><span class="sxs-lookup"><span data-stu-id="d4c5e-550">Minimum permission level</span></span>](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| <span data-ttu-id="d4c5e-551">ReadWriteMailbox</span><span class="sxs-lookup"><span data-stu-id="d4c5e-551">ReadWriteMailbox</span></span>|
|[<span data-ttu-id="d4c5e-552">Zutreffender Outlook-Modus</span><span class="sxs-lookup"><span data-stu-id="d4c5e-552">Applicable Outlook mode</span></span>](https://docs.microsoft.com/outlook/add-ins/#extension-points)| <span data-ttu-id="d4c5e-553">Verfassen oder Lesen</span><span class="sxs-lookup"><span data-stu-id="d4c5e-553">Compose or read</span></span>|

##### <a name="example"></a><span data-ttu-id="d4c5e-554">Beispiel</span><span class="sxs-lookup"><span data-stu-id="d4c5e-554">Example</span></span>

<span data-ttu-id="d4c5e-555">Das folgende Beispiel ruft `makeEwsRequestAsync` zum Verwenden des `GetItem`-Vorgangs auf, um den Betreff eines Elements abzurufen.</span><span class="sxs-lookup"><span data-stu-id="d4c5e-555">The following example calls `makeEwsRequestAsync` to use the `GetItem` operation to get the subject of an item.</span></span>
