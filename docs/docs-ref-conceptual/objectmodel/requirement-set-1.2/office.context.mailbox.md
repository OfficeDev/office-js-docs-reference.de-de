...
Typ: [LocalClientTime](/javascript/api/outlook_1_2/office.LocalClientTime)
...
|Name| Typ| Beschreibung|
|---|---|---|
|`input`| [LocalClientTime](/javascript/api/outlook_1_2/office.LocalClientTime)|Der zu konvertierende Wert für die lokale Uhrzeit.|
